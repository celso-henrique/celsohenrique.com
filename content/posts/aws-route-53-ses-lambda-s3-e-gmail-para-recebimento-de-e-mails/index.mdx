...
Caso ocorram problemas de envio ou recebimento verifique o Cloudwatch da sua lambda, lá devem haver logs das execuções, normalmente os problemas são limitações de permissões no bucket, lambda ou sandbox. 
