...
Com a evolução do front-end e consequentemente sua complexidade e responsabilidades, vimos a popularização dos testes e o surgimento de ferramentas para executá-los. Lembro de ter visto pela primeira vez no livro "Segredos do Ninja JavaScript" maneiras de realizar testes unitários e ter ficado encantado na época. Os testes durante um bom tempo rodavam em um navegador real ou headless, o que tornava a tarefa de testar web components possível desde que estes navegadores suportassem as suas especificações ou tivéssemos os polyfills.
